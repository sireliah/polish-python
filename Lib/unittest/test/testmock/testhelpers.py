...
klasa SomeClass(object):
    ...
    def two(self):
        dalej
    def three(self, a=Nic):
        dalej



klasa AnyTest(unittest.TestCase):
...
klasa CallTest(unittest.TestCase):
    ...
    def test_call_ne(self):
        ...
        self.assertNieprawda(_Call(((1, 2, 3),)) != call(1, 2, 3))
        self.assertPrawda(_Call(((1, 2), {})) != call(1, 2, 3))


    def test_call_non_tuples(self):
        kall = _Call(((1, 2, 3),))
        dla value w 1, Nic, self, int:
            self.assertNotEqual(kall, value)
            self.assertNieprawda(kall == value)
...
klasa SpecSignatureTest(unittest.TestCase):
    ...
    def test_create_autospec_unbound_methods(self):
        # see mock issue 128
        # this jest expected to fail until the issue jest fixed
        zwróć
        klasa Foo(object):
            def foo(self):
                dalej
    ...
    def test_spec_as_list(self):
        # because spec jako a list of strings w the mock constructor means
        # something very different we treat a list instance jako the type.
    ...
    def test_attributes(self):
        ...
        dla mock w (sub_mock, sub_mock.attr):
            self._check_someclass_mock(mock)


    def test_builtin_functions_types(self):
        # we could replace builtin functions / methods przy a function
        # przy *args / **kwargs signature. Using the builtin method type
        # jako a spec seems to work fairly well though.
        klasa BuiltinSubclass(list):
            def bar(self, arg):
                dalej
            sorted = sorted
            attr = {}
    ...
    def test_spec_set(self):
        ...
        dla spec w (Sub, Sub()):
            mock = create_autospec(spec, spec_set=Prawda)
            self._check_someclass_mock(mock)
    ...
    def test_descriptors(self):
        ...
        klasa Baz(SomeClass, Bar):
            dalej

        dla spec w (Foo, Foo(), Bar, Bar(), Baz, Baz()):
    ...
    def test_recursive(self):
        ...
        mock()
        self.assertNieprawda(mock.B.called)
    ...
    def test_spec_inheritance_for_classes(self):
        ...
        dla this_mock w class_mock, class_mock():
            this_mock.a(x=5)
        ...
        # The zwróć value isn't isn't callable
    ...
    def test_builtins(self):
        # used to fail przy infinite recursion
        create_autospec(1)
        ...
        create_autospec(Nieprawda)
        create_autospec(Prawda)
    ...
    def test_skip_attributeerrors(self):
        klasa Raiser(object):
            def __get__(self, obj, type=Nic):
                jeżeli obj jest Nic:
                    podnieś AttributeError('Can only be accessed via an instance')

        klasa RaiserClass(object):
            podnieśr = Raiser()
        ...
        # check we can fetch the podnieśr attribute oraz it has no spec
        obj = s.raiser
        obj.foo, obj.bar
    ...
    def test_class_with_no_init(self):
        # this used to podnieś an exception
        # due to trying to get a signature z object.__init__
        klasa Foo(object):
            dalej
        create_autospec(Foo)
    ...
    def test_create_autospec_none(self):
        ...
        mock = create_autospec(Foo)
        none = mock.bar
        self.assertNotIsInstance(none, type(Nic))
...
klasa TestCallList(unittest.TestCase):
    ...
    def test_args_list_contains_call_list(self):
        ...
        dla kall w call(1, 2), call(a=3), call(3, 4), call(b=6):
