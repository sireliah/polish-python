...
def str_aligned(X): zwróć (((ulong_t)(X) & (sizeof (int) - 1)) == 0)


# Included z sys/strft.h
tdelta_t_sz = 12
FTEV_MASK = 0x1FFF
FTEV_ISWR = 0x8000
FTEV_CS = 0x4000
...
FTEV_QWINNER = 0x010F
FTEV_GEWRITE = 0x0101
def FTFLW_HASH(h): zwróć (((unsigned)(h))%ftflw_hash_sz)
...
PERIM_INNER = 1
PERIM_OUTER = 2
def datamsg(type): zwróć \

def straln(a): zwróć (caddr_t)((intptr_t)(a) & ~(sizeof (int)-1))
...
IN_LOOPBACKNET = 127
def IN_SET_LOOPBACK_ADDR(a): zwróć \

def IN6_IS_ADDR_UNSPECIFIED(addr): zwróć \

def IN6_IS_ADDR_LOOPBACK(addr): zwróć \

def IN6_IS_ADDR_LOOPBACK(addr): zwróć \

def IN6_IS_ADDR_MULTICAST(addr): zwróć \

def IN6_IS_ADDR_MULTICAST(addr): zwróć \

def IN6_IS_ADDR_LINKLOCAL(addr): zwróć \

def IN6_IS_ADDR_LINKLOCAL(addr): zwróć \

def IN6_IS_ADDR_SITELOCAL(addr): zwróć \

def IN6_IS_ADDR_SITELOCAL(addr): zwróć \

def IN6_IS_ADDR_V4MAPPED(addr): zwróć \

def IN6_IS_ADDR_V4MAPPED(addr): zwróć \

def IN6_IS_ADDR_V4MAPPED_ANY(addr): zwróć \

def IN6_IS_ADDR_V4MAPPED_ANY(addr): zwróć \

def IN6_IS_ADDR_V4COMPAT(addr): zwróć \

def IN6_IS_ADDR_V4COMPAT(addr): zwróć \

def IN6_IS_ADDR_MC_RESERVED(addr): zwróć \

def IN6_IS_ADDR_MC_RESERVED(addr): zwróć \

def IN6_IS_ADDR_MC_NODELOCAL(addr): zwróć \

def IN6_IS_ADDR_MC_NODELOCAL(addr): zwróć \

def IN6_IS_ADDR_MC_LINKLOCAL(addr): zwróć \

def IN6_IS_ADDR_MC_LINKLOCAL(addr): zwróć \

def IN6_IS_ADDR_MC_SITELOCAL(addr): zwróć \

def IN6_IS_ADDR_MC_SITELOCAL(addr): zwróć \

def IN6_IS_ADDR_MC_ORGLOCAL(addr): zwróć \

def IN6_IS_ADDR_MC_ORGLOCAL(addr): zwróć \

def IN6_IS_ADDR_MC_GLOBAL(addr): zwróć \
