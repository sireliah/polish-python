...
"""Unit tests dla pytree.py.

NOTE: Please *don't* add doc strings to individual test methods!
In verbose mode, printing of the module, klasa oraz method name jest much
...
klasa TestNodes(support.TestCase):

    """Unit tests dla nodes (Base, Leaf, Node)."""

    def test_instantiate_base(self):
        jeżeli __debug__:
            # Test that instantiating Base() podnieśs an AssertionError
    ...
    def test_leaf_str_numeric_value(self):
        # Make sure that the Leaf's value jest stringified. Failing to
        #  do this can cause a TypeError w certain situations.
        l1 = pytree.Leaf(2, 5)
        l1.prefix = "foo_"
    ...
    def test_leaf_prefix(self):
        ...
        self.assertNieprawda(l1.was_changed)
        l1.prefix = "  ##\n\n"
        self.assertEqual(l1.prefix, "  ##\n\n")
        self.assertPrawda(l1.was_changed)
    ...
    def test_replace(self):
        ...
        self.assertNieprawda(n1.was_changed)
        l2new = pytree.Leaf(100, "-")
        l2.replace(l2new)
        self.assertEqual(n1.children, [l1, l2new, l3])
        self.assertIsInstance(n1.children, list)
        self.assertPrawda(n1.was_changed)
    ...
    def test_changed(self):
        ...
        self.assertNieprawda(l1.was_changed)
        self.assertNieprawda(n1.was_changed)
        self.assertNieprawda(n2.was_changed)

        n1.changed()
        self.assertPrawda(n1.was_changed)
        self.assertPrawda(n2.was_changed)
        self.assertNieprawda(l1.was_changed)

    def test_leaf_constructor_prefix(self):
        dla prefix w ("xyz_", ""):
            l1 = pytree.Leaf(100, "self", prefix=prefix)
            self.assertPrawda(str(l1), prefix + "self")
    ...
    def test_node_constructor_prefix(self):
        dla prefix w ("xyz_", ""):
            ...
            self.assertPrawda(str(n1), prefix + "self_foo")
    ...
    def test_remove(self):
        ...
        self.assertEqual(n1.parent, Nic)
        self.assertEqual(n2.parent, Nic)
        self.assertNieprawda(n1.was_changed)
        self.assertPrawda(n2.was_changed)
        ...
        self.assertEqual(l1.parent, Nic)
        self.assertEqual(n1.parent, Nic)
        self.assertEqual(n2.parent, Nic)
        self.assertPrawda(n1.was_changed)
        self.assertPrawda(n2.was_changed)
    ...
    def test_node_set_child(self):
        ...
        # I don't care what it podnieśs, so long jako it's an exception
    ...
    def test_node_next_sibling(self):
        ...
        self.assertEqual(n2.next_sibling, Nic)
        self.assertEqual(p1.next_sibling, Nic)
    ...
    def test_leaf_next_sibling(self):
        ...
        self.assertEqual(l2.next_sibling, Nic)
        self.assertEqual(p1.next_sibling, Nic)
    ...
    def test_node_prev_sibling(self):
        ...
        self.assertEqual(n1.prev_sibling, Nic)
        self.assertEqual(p1.prev_sibling, Nic)
    ...
    def test_leaf_prev_sibling(self):
        ...
        self.assertEqual(l1.prev_sibling, Nic)
        self.assertEqual(p1.prev_sibling, Nic)


klasa TestPatterns(support.TestCase):

    """Unit tests dla tree matching patterns."""
    ...
    def test_basic_patterns(self):
        ...
        r = {}
        self.assertNieprawda(pl.match(root, results=r))
        self.assertEqual(r, {})
        self.assertNieprawda(pl.match(n1, results=r))
        self.assertEqual(r, {})
        self.assertNieprawda(pl.match(n2, results=r))
        self.assertEqual(r, {})
        self.assertPrawda(pl.match(l1, results=r))
        self.assertEqual(r, {"pl": l1})
        r = {}
        self.assertNieprawda(pl.match(l2, results=r))
        self.assertEqual(r, {})
        # Build a pattern matching a node
        pn = pytree.NodePattern(1000, [pl], name="pn")
        self.assertNieprawda(pn.match(root, results=r))
        self.assertEqual(r, {})
        self.assertNieprawda(pn.match(n1, results=r))
        self.assertEqual(r, {})
        self.assertPrawda(pn.match(n2, results=r))
        self.assertEqual(r, {"pn": n2, "pl": l3})
        r = {}
        self.assertNieprawda(pn.match(l1, results=r))
        self.assertEqual(r, {})
        self.assertNieprawda(pn.match(l2, results=r))
        self.assertEqual(r, {})

    def test_wildcard(self):
        # Build a tree dla testing
        l1 = pytree.Leaf(100, "foo")
        l2 = pytree.Leaf(100, "bar")
        l3 = pytree.Leaf(100, "foo")
        n1 = pytree.Node(1000, [l1, l2])
        ...
        r = {}
        self.assertNieprawda(pw.match_seq([root], r))
        self.assertEqual(r, {})
        self.assertNieprawda(pw.match_seq([n1], r))
        self.assertEqual(r, {})
        self.assertPrawda(pw.match_seq([n2], r))
        # These are easier to debug
        self.assertEqual(sorted(r.keys()), ["pl", "pn", "pw"])
        self.assertEqual(r["pl"], l1)
        self.assertEqual(r["pn"], n2)
        self.assertEqual(r["pw"], [n2])
        # But this jest equivalent
        self.assertEqual(r, {"pl": l1, "pn": n2, "pw": [n2]})
        r = {}
        self.assertPrawda(pw.match_seq([l1, l3], r))
    ...
    def test_generate_matches(self):
        ...
        pw = pytree.WildcardPattern([[pa, pb, pc], [pd, pe],
                                     [pa, pb], [pc, pd], [pe, pf]],
                                    min=1, max=4, name="pw")
        self.assertEqual([x[0] dla x w pw.generate_matches(leaves)],
                         [3, 5, 2, 4, 6])
    ...
    def test_has_key_example(self):
        ...
        r = {}
        self.assertPrawda(pattern.match(node, r))
