...
XER_OV = 0x40000000
XER_CA = 0x20000000
def XER_COMP_BYTE(xer): zwróć ((xer >> 8) & 0x000000FF)

def XER_LENGTH(xer): zwróć (xer & 0x0000007F)
...
def BUID_7F_SRVAL(raddr): zwróć (0x87F00000 | (((uint)(raddr)) >> 28))
...
BT_VS = 0x2
BT_VP = 0x1
def BAT_ESEG(dbatu): zwróć (((uint)(dbatu) >> 28))
