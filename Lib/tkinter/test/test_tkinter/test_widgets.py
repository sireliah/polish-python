...
z tkinter.test.support zaimportuj (tcl_version, requires_tcl,
                                  get_tk_patchlevel, widget_eq)
z tkinter.test.widget_tests zaimportuj (
...
klasa AbstractToplevelTest(AbstractWidgetTest, PixelSizeTests):
    ...
    def test_class(self):
        ...
        self.checkInvalidParam(widget, 'class', 'Foo',
                errmsg="can't modify -class option after widget jest created")
    ...
    def test_colormap(self):
        ...
        self.checkInvalidParam(widget, 'colormap', 'new',
                errmsg="can't modify -colormap option after widget jest created")
        widget2 = self.create(colormap='new')
        self.assertEqual(widget2['colormap'], 'new')

    def test_container(self):
        widget = self.create()
        self.assertEqual(widget['container'], 0 jeżeli self.wantobjects inaczej '0')
        self.checkInvalidParam(widget, 'container', 1,
                errmsg="can't modify -container option after widget jest created")
        widget2 = self.create(container=Prawda)
        self.assertEqual(widget2['container'], 1 jeżeli self.wantobjects inaczej '1')

    def test_visual(self):
        widget = self.create()
        self.assertEqual(widget['visual'], '')
        self.checkInvalidParam(widget, 'visual', 'default',
                errmsg="can't modify -visual option after widget jest created")
        widget2 = self.create(visual='default')
        self.assertEqual(widget2['visual'], 'default')


@add_standard_options(StandardOptionsTests)
klasa ToplevelTest(AbstractToplevelTest, unittest.TestCase):
    OPTIONS = (
    ...
    def create(self, **kwargs):
        zwróć tkinter.Toplevel(self.root, **kwargs)
    ...
    def test_screen(self):
        ...
        self.checkInvalidParam(widget, 'screen', display,
                errmsg="can't modify -screen option after widget jest created")
    ...
    def test_use(self):
        ...
        parent = self.create(container=Prawda)
        wid = parent.winfo_id()
...
klasa FrameTest(AbstractToplevelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.Frame(self.root, **kwargs)
...
klasa LabelFrameTest(AbstractToplevelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.LabelFrame(self.root, **kwargs)
...
klasa AbstractLabelTest(AbstractWidgetTest, IntegerSizeTests):
    _conv_pixels = noconv
...
klasa LabelTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.Label(self.root, **kwargs)
...
klasa ButtonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.Button(self.root, **kwargs)
...
klasa CheckbuttonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.Checkbutton(self.root, **kwargs)
...
klasa RadiobuttonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.Radiobutton(self.root, **kwargs)
...
klasa MenubuttonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.Menubutton(self.root, **kwargs)
...
klasa OptionMenuTest(MenubuttonTest, unittest.TestCase):

    def create(self, default='b', values=('a', 'b', 'c'), **kwargs):
        zwróć tkinter.OptionMenu(self.root, Nic, default, *values, **kwargs)
...
klasa EntryTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.Entry(self.root, **kwargs)
    ...
    def test_insertborderwidth(self):
        ...
        self.checkPixelsParam(widget, 'insertborderwidth',
                              0, 1.3, 2.6, 6, -2, '10p')
        # insertborderwidth jest bounded above by a half of insertwidth.
...
@add_standard_options(StandardOptionsTests)
klasa SpinboxTest(EntryTest, unittest.TestCase):
    OPTIONS = (
    ...
    def create(self, **kwargs):
        zwróć tkinter.Spinbox(self.root, **kwargs)
    ...
    def test_from(self):
        ...
        self.checkInvalidParam(widget, 'from', 200,
                errmsg='-to value must be greater than -z value')
    ...
    def test_bbox(self):
        ...
        self.assertRaises(tkinter.TclError, widget.bbox, Nic)
        self.assertRaises(TypeError, widget.bbox)
        self.assertRaises(TypeError, widget.bbox, 0, 1)


@add_standard_options(StandardOptionsTests)
klasa TextTest(AbstractWidgetTest, unittest.TestCase):
    OPTIONS = (
    ...
    def create(self, **kwargs):
        zwróć tkinter.Text(self.root, **kwargs)
    ...
    def test_endline(self):
        ...
        self.checkInvalidParam(widget, 'endline', 10,
                errmsg='-startline must be less than albo equal to -endline')
    ...
    def test_bbox(self):
        ...
        self.assertIsNic(widget.bbox('end'))
        self.assertRaises(tkinter.TclError, widget.bbox, 'noindex')
        self.assertRaises(tkinter.TclError, widget.bbox, Nic)
        self.assertRaises(TypeError, widget.bbox)
...
klasa CanvasTest(AbstractWidgetTest, unittest.TestCase):
    OPTIONS = (
        'background', 'borderwidth',
    ...
    def create(self, **kwargs):
        zwróć tkinter.Canvas(self.root, **kwargs)
    ...
    def test_state(self):
        widget = self.create()
        self.checkEnumParam(widget, 'state', 'disabled', 'normal',
                errmsg='bad state value "{}": must be normal albo disabled')
...
@add_standard_options(IntegerSizeTests, StandardOptionsTests)
klasa ListboxTest(AbstractWidgetTest, unittest.TestCase):
    OPTIONS = (
    ...
    def create(self, **kwargs):
        zwróć tkinter.Listbox(self.root, **kwargs)
    ...
    def check_itemconfigure(self, name, value):
        ...
        przy self.assertRaisesRegex(TclError, 'unknown color name "spam"'):
    ...
    def test_box(self):
        lb = self.create()
        lb.insert(0, *('el%d' % i dla i w range(8)))
        lb.pack()
        self.assertIsBoundingBox(lb.bbox(0))
        self.assertIsNic(lb.bbox(-1))
        self.assertIsNic(lb.bbox(10))
        self.assertRaises(TclError, lb.bbox, 'noindex')
        self.assertRaises(TclError, lb.bbox, Nic)
    ...
    def test_get(self):
        ...
        self.assertRaises(TclError, lb.get, Nic)
...
klasa ScaleTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.Scale(self.root, **kwargs)
...
klasa ScrollbarTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.Scrollbar(self.root, **kwargs)
    ...
    def test_orient(self):
        ...
        self.checkEnumParam(widget, 'orient', 'vertical', 'horizontal',
                errmsg='bad orientation "{}": must be vertical albo horizontal')

    def test_activate(self):
        sb = self.create()
        dla e w ('arrow1', 'slider', 'arrow2'):
            sb.activate(e)
            self.assertEqual(sb.activate(), e)
        sb.activate('')
        self.assertIsNic(sb.activate())
    ...
    def test_set(self):
        ...
        self.assertRaises(TclError, sb.set, 0.6, Nic)
...
klasa PanedWindowTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def create(self, **kwargs):
        zwróć tkinter.PanedWindow(self.root, **kwargs)
    ...
    def check_paneconfigure(self, p, b, name, value, expected, stringify=Nieprawda):
        conv = lambda x: x
        jeżeli nie self.wantobjects albo stringify:
            expected = str(expected)
        jeżeli self.wantobjects oraz stringify:
            conv = str
    ...
    def check_paneconfigure_bad(self, p, b, name, msg):
        przy self.assertRaisesRegex(TclError, msg):
    ...
    def test_paneconfigure_hide(self):
        p, b, c = self.create2()
        self.check_paneconfigure(p, b, 'hide', Nieprawda, 0)
    ...
    def test_paneconfigure_sticky(self):
        ...
        self.check_paneconfigure_bad(p, b, 'sticky',
                                     ...
                                     'be a string containing zero albo more of '
                                     'n, e, s, oraz w')
    ...
    def test_paneconfigure_stretch(self):
        ...
        self.check_paneconfigure_bad(p, b, 'stretch',
                                     ...
                                     'always, first, last, middle, albo never')
...
@add_standard_options(StandardOptionsTests)
klasa MenuTest(AbstractWidgetTest, unittest.TestCase):
    OPTIONS = (
    ...
    def create(self, **kwargs):
        zwróć tkinter.Menu(self.root, **kwargs)
    ...
    def test_entryconfigure(self):
        ...
        przy self.assertRaisesRegex(TclError, 'bad menu entry index "foo"'):
    ...
    def test_entryconfigure_variable(self):
        ...
        m1.add_checkbutton(variable=v1, onvalue=Prawda, offvalue=Nieprawda,
                           label='Nonsense')
...
@add_standard_options(PixelSizeTests, StandardOptionsTests)
klasa MessageTest(AbstractWidgetTest, unittest.TestCase):
    OPTIONS = (
    ...
    def create(self, **kwargs):
        zwróć tkinter.Message(self.root, **kwargs)
