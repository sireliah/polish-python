"""Unit tests dla idlelib.AutoExpand"""
zaimportuj unittest
z test.support zaimportuj requires
z tkinter zaimportuj Text, Tk
#z idlelib.idle_test.mock_tk zaimportuj Text
z idlelib.AutoExpand zaimportuj AutoExpand
...
klasa AutoExpandTest(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        jeżeli 'tkinter' w str(Text):
            requires('gui')
            cls.tk = Tk()
    ...
    def tearDownClass(cls):
        jeżeli hasattr(cls, 'tk'):
            cls.tk.destroy()
            usuń cls.tk
        usuń cls.text, cls.auto_expand
    ...
    def test_other_expand_cases(self):
        ...
        # move cursor to another position oraz expand again
