"""About Dialog dla IDLE

"""

zaimportuj os
z sys zaimportuj version
z tkinter zaimportuj *
z idlelib zaimportuj textView

klasa AboutDialog(Toplevel):
    """Modal about dialog dla idle

    """
    def __init__(self, parent, title, _htest=Nieprawda):
        """
        ...
        self.geometry("+%d+%d" % (
                        ...
                        parent.winfo_rooty()+(30 jeżeli nie _htest inaczej 100)))
        self.bg = "#707070"
        self.fg = "#ffffff"
        self.CreateWidgets()
    ...
    def display_file_text(self, title, filename, encoding=Nic):
