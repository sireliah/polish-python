""" Python Character Mapping Codec mac_farsi generated z 'MAPPINGS/VENDORS/APPLE/FARSI.TXT' przy gencodec.py.
...
decoding_table = (
    ...
    ','        #  0x2C -> COMMA, left-right; w Arabic-script context, displayed jako 0x066C ARABIC THOUSANDS SEPARATOR
    '-'        #  0x2D -> HYPHEN-MINUS, left-right
    '.'        #  0x2E -> FULL STOP, left-right; w Arabic-script context, displayed jako 0x066B ARABIC DECIMAL SEPARATOR
    '/'        #  0x2F -> SOLIDUS, left-right
    '0'        #  0x30 -> DIGIT ZERO;  w Arabic-script context, displayed jako 0x06F0 EXTENDED ARABIC-INDIC DIGIT ZERO
    '1'        #  0x31 -> DIGIT ONE;   w Arabic-script context, displayed jako 0x06F1 EXTENDED ARABIC-INDIC DIGIT ONE
    '2'        #  0x32 -> DIGIT TWO;   w Arabic-script context, displayed jako 0x06F2 EXTENDED ARABIC-INDIC DIGIT TWO
    '3'        #  0x33 -> DIGIT THREE; w Arabic-script context, displayed jako 0x06F3 EXTENDED ARABIC-INDIC DIGIT THREE
    '4'        #  0x34 -> DIGIT FOUR;  w Arabic-script context, displayed jako 0x06F4 EXTENDED ARABIC-INDIC DIGIT FOUR
    '5'        #  0x35 -> DIGIT FIVE;  w Arabic-script context, displayed jako 0x06F5 EXTENDED ARABIC-INDIC DIGIT FIVE
    '6'        #  0x36 -> DIGIT SIX;   w Arabic-script context, displayed jako 0x06F6 EXTENDED ARABIC-INDIC DIGIT SIX
    '7'        #  0x37 -> DIGIT SEVEN; w Arabic-script context, displayed jako 0x06F7 EXTENDED ARABIC-INDIC DIGIT SEVEN
    '8'        #  0x38 -> DIGIT EIGHT; w Arabic-script context, displayed jako 0x06F8 EXTENDED ARABIC-INDIC DIGIT EIGHT
    '9'        #  0x39 -> DIGIT NINE;  w Arabic-script context, displayed jako 0x06F9 EXTENDED ARABIC-INDIC DIGIT NINE
