""" Python Character Mapping Codec generated z 'VENDORS/MICSFT/PC/CP864.TXT' przy gencodec.py.
...
decoding_map.update({
    ...
    0x00a6: Nic,       #  UNDEFINED
    0x00a7: Nic,       #  UNDEFINED
