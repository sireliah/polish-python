...
klasa ColorsysTest(unittest.TestCase):
    ...
    def test_hsv_roundtrip(self):
        dla r w frange(0.0, 1.0, 0.2):
            dla g w frange(0.0, 1.0, 0.2):
                dla b w frange(0.0, 1.0, 0.2):
                    rgb = (r, g, b)
