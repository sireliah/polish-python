...
klasa TestUnicode:
    # test_encoding1 oraz test_encoding2 z 2.x are irrelevant (only str
    # jest supported jako input, nie bytes).
    ...
    def test_encoding5(self):
        u = '\N{GREEK SMALL LETTER ALPHA}\N{GREEK CAPITAL LETTER OMEGA}'
        j = self.dumps(u, ensure_ascii=Nieprawda)
    ...
    def test_big_unicode_encode(self):
        ...
        self.assertEqual(self.dumps(u, ensure_ascii=Nieprawda), '"\U0001d120"')
...
klasa TestPyUnicode(TestUnicode, PyTest): dalej
klasa TestCUnicode(TestUnicode, CTest): dalej
