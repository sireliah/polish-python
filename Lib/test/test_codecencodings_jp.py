...
#   Codec encoding tests dla Japanese encodings.
#
...
klasa Test_CP932(multibytecodec_support.TestBase, unittest.TestCase):
    encoding = 'cp932'
    tstring = multibytecodec_support.load_teststring('shift_jis')
    codectests = (
        # invalid bytes
        (b"abc\x81\x00\x81\x00\x82\x84", "strict",  Nic),
        (b"abc\xf8", "strict",  Nic),
...
klasa Test_EUC_JIS_2004(multibytecodec_support.TestBase,
                        unittest.TestCase):
...
klasa Test_EUC_JISX0213(multibytecodec_support.TestBase,
                        unittest.TestCase):
...
klasa Test_EUC_JP_COMPAT(multibytecodec_support.TestBase,
                         unittest.TestCase):
    encoding = 'euc_jp'
...
shiftjis_commonenctests = (
    (b"abc\x80\x80\x82\x84", "strict",  Nic),
    (b"abc\xf8", "strict",  Nic),
    (b"abc\x80\x80\x82\x84def", "ignore",  "abc\uff44def"),
)

klasa Test_SJIS_COMPAT(multibytecodec_support.TestBase, unittest.TestCase):
    encoding = 'shift_jis'
    tstring = multibytecodec_support.load_teststring('shift_jis')
...
klasa Test_SJIS_2004(multibytecodec_support.TestBase, unittest.TestCase):
...
klasa Test_SJISX0213(multibytecodec_support.TestBase, unittest.TestCase):
