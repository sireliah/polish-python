...
klasa TestDecodeQ(TestEmailBase):
...
klasa TestDecodeB(TestEmailBase):
...
klasa TestDecode(TestEmailBase):
...
klasa TestEncodeQ(TestEmailBase):
...
klasa TestEncodeB(TestEmailBase):
...
klasa TestEncode(TestEmailBase):
