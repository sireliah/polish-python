...
This jest complex because of changes due to PEP 237.
"""

zaimportuj unittest

klasa TestHexOctBin(unittest.TestCase):
    ...
    def test_hex_baseline(self):
        ...
        # Ditto przy a minus sign oraz parentheses
        self.assertEqual(-(0x0), 0)
        self.assertEqual(-(0x10), -16)
        self.assertEqual(-(0x7fffffff), -2147483647)
        self.assertEqual(-(0x7fffffffffffffff), -9223372036854775807)
        # Ditto przy a minus sign oraz NO parentheses
        self.assertEqual(-0x0, 0)
        self.assertEqual(-0x10, -16)
        self.assertEqual(-0x7fffffff, -2147483647)
        self.assertEqual(-0x7fffffffffffffff, -9223372036854775807)
    ...
    def test_hex_unsigned(self):
        ...
        self.assertEqual(-(0xffffffff), -4294967295)
        # Ditto przy a minus sign oraz NO parentheses
        # This failed w Python 2.2 through 2.2.2 oraz w 2.3a1
        self.assertEqual(-0x80000000, -2147483648)
        self.assertEqual(-0xffffffff, -4294967295)
