"""Test script dla the binhex C module
...
klasa BinHexTestCase(unittest.TestCase):
    ...
    def test_binhex_error_on_long_filename(self):
        """
        The testcase fails jeżeli no exception jest podnieśd when a filename parameter provided to binhex.binhex()
        jest too long, albo jeżeli the exception podnieśd w binhex.binhex() jest nie an instance of binhex.Error.
        """
