...
zaimportuj unittest
z test zaimportuj audiotests
z audioop zaimportuj byteswap
zaimportuj os
zaimportuj io
zaimportuj sys
zaimportuj struct
...
klasa AifcTest(audiotests.AudioWriteTests,
               audiotests.AudioTestsWithSourceFile):
    module = aifc
    close_fd = Prawda
    test_unseekable_read = Nic


klasa AifcPCM8Test(AifcTest, unittest.TestCase):
...
klasa AifcPCM16Test(AifcTest, unittest.TestCase):
...
klasa AifcPCM24Test(AifcTest, unittest.TestCase):
...
klasa AifcPCM32Test(AifcTest, unittest.TestCase):
...
klasa AifcULAWTest(AifcTest, unittest.TestCase):
...
klasa AifcALAWTest(AifcTest, unittest.TestCase):
...
klasa AifcMiscTest(audiotests.AudioTests, unittest.TestCase):
    ...
    def test_write_header_comptype_sampwidth(self):
        dla comptype w (b'ULAW', b'ulaw', b'ALAW', b'alaw', b'G722'):
    ...
    def test_write_markers_values(self):
        fout = aifc.open(io.BytesIO(), 'wb')
        self.assertEqual(fout.getmarkers(), Nic)
...
klasa AIFCLowLevelTest(unittest.TestCase):
    ...
    def test_wrong_open_mode(self):
        przy self.assertRaises(aifc.Error):
    ...
    def test_read_wrong_marks(self):
        ...
        self.assertEqual(f.getmarkers(), Nic)
    ...
    def test_write_markers_raises(self):
        ...
        self.assertRaises(aifc.Error, fout.setmark, 1, 0, Nic)
