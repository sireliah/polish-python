...
klasa WaveTest(audiotests.AudioWriteTests,
               audiotests.AudioTestsWithSourceFile):
    module = wave


klasa WavePCM8Test(WaveTest, unittest.TestCase):
...
klasa WavePCM16Test(WaveTest, unittest.TestCase):
...
klasa WavePCM24Test(WaveTest, unittest.TestCase):
...
klasa WavePCM32Test(WaveTest, unittest.TestCase):
