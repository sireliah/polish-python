...
This uses the test codec w testcodec.py oraz thus also tests the
...
def codec_search_function(encoding):
    jeżeli encoding == 'testcodec':
        z test zaimportuj testcodec
        zwróć tuple(testcodec.getregentry())
    zwróć Nic
...
klasa CharmapCodecTest(unittest.TestCase):
