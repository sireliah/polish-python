...
klasa SunauTest(audiotests.AudioWriteTests,
                audiotests.AudioTestsWithSourceFile):
    module = sunau


klasa SunauPCM8Test(SunauTest, unittest.TestCase):
...
klasa SunauPCM16Test(SunauTest, unittest.TestCase):
...
klasa SunauPCM24Test(SunauTest, unittest.TestCase):
...
klasa SunauPCM32Test(SunauTest, unittest.TestCase):
...
klasa SunauULAWTest(SunauTest, unittest.TestCase):
