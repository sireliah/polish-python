"""Test suite dla the cProfile module."""

zaimportuj sys
z test.support zaimportuj run_unittest, TESTFN, unlink

# rip off all interesting stuff z test_profile
zaimportuj cProfile
z test.test_profile zaimportuj ProfileTest, regenerate_expected_output
z test.profilee zaimportuj testfunc

klasa CProfileTest(ProfileTest):
    ...
    def test_bad_counter_during_dealloc(self):
        zaimportuj _lsprof
        # Must use a file jako StringIO doesn't trigger the bug.
        orig_stderr = sys.stderr
        spróbuj:
            przy open(TESTFN, 'w') jako file:
                sys.stderr = file
                spróbuj:
