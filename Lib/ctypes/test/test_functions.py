"""
Here jest probably the place to write the docs, since the test-cases
...
klasa FunctionTestCase(unittest.TestCase):

    def test_mro(self):
        # w Python 2.3, this podnieśs TypeError: MRO conflict among bases classes,
        # w Python 2.2 it works.
        #
        # But w early versions of _ctypes.c, the result of tp_new
        # wasn't checked, oraz it even crashed Python.
        # Found by Greg Chapman.

        spróbuj:
            klasa X(object, Array):
                _length_ = 5
                _type_ = "i"
        wyjąwszy TypeError:
            dalej
        ...
        spróbuj:
            klasa X(object, _SimpleCData):
                _type_ = "i"
        wyjąwszy TypeError:
            dalej

        spróbuj:
            klasa X(object, Structure):
                _fields_ = []
        wyjąwszy TypeError:
            dalej
    ...
    def test_voidresult(self):
        ...
        result = c_int()
        self.assertEqual(Nic, f(1, 2, byref(result)))
    ...
    def test_intresult(self):
        ...
        # If we declare the function to zwróć a short,
        # jest the high part split off?
        f.restype = c_short
        result = f(1, 2, 3, 4, 5.0, 6.0)
        self.assertEqual(result, 21)
        self.assertEqual(type(result), int)
        ...
        # You cannot assign character format codes jako restype any longer
    ...
    def test_pointers(self):
        ...
        # It jest dangerous, however, because you don't control the lifetime
        # of the pointer:
