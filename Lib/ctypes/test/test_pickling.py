...
klasa PickleTest:
    def dumps(self, item):
        zwróć pickle.dumps(item, self.proto)

    def loads(self, item):
        zwróć pickle.loads(item)
