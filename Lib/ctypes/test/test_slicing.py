...
klasa SlicesTestCase(unittest.TestCase):
    ...
    def test_char_ptr_with_free(self):
        ...
        klasa allocated_c_char_p(c_char_p):
            dalej
    ...
    def test_wchar_ptr(self):
        ...
        jeżeli sizeof(c_wchar) == sizeof(c_short):
            dll.my_wcsdup.restype = POINTER(c_short)
        albo_inaczej sizeof(c_wchar) == sizeof(c_int):
            dll.my_wcsdup.restype = POINTER(c_int)
        albo_inaczej sizeof(c_wchar) == sizeof(c_long):
            dll.my_wcsdup.restype = POINTER(c_long)
        inaczej:
            self.skipTest('Pointers to c_wchar are nie supported')
        res = dll.my_wcsdup(s)
