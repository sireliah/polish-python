...
klasa MemFunctionsTest(unittest.TestCase):
    @unittest.skip('test disabled')
    def test_overflow(self):
        # string_at oraz wstring_at must use the Python calling
        # convention (which acquires the GIL oraz checks the Python
        # error flag).  Provoke an error oraz catch it; see also issue
    ...
    def test_memmove(self):
        ...
        # jest allocated w high address space.
