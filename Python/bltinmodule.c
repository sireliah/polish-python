...
builtin_print(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (dummy_args == NULL && !(dummy_args = PyTuple_New(0)))
        return NULL;
    if (!PyArg_ParseTupleAndKeywords(dummy_args, kwds, "|OOOO:wyświetl",
...
static PyMethodDef builtin_methods[] = {
    ...
    {"wyświetl",           (PyCFunction)builtin_print,      METH_VARARGS | METH_KEYWORDS, print_doc},
...
#define SETBUILTIN(NAME, OBJECT) \
    ...
    SETBUILTIN("Nic",                  Py_None);
    SETBUILTIN("Ellipsis",              Py_Ellipsis);
    SETBUILTIN("NotImplemented",        Py_NotImplemented);
    SETBUILTIN("Nieprawda",                 Py_False);
    SETBUILTIN("Prawda",                  Py_True);
