# An absurd workaround dla the lack of arithmetic w MS's resource compiler.
...
print(" * oraz %d*1000 + %d*10 + %d = %d" % (micro, levelnum, serial, field3))
print(" */")
